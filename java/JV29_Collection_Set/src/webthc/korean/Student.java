...
//	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(avg, eng, grade, kor, math, stuName, stuNo, total);
	}
	...
	public boolean equals(Object obj) {
		...
		return Float.floatToIntBits(avg) == Float.floatToIntBits(other.avg) && eng == other.eng && grade == other.grade
				&& kor == other.kor && math == other.math && Objects.equals(stuName, other.stuName)
				&& Objects.equals(stuNo, other.stuNo) && total == other.total;
	}
}
